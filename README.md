...
Current build: **0.2.6**. Download it from [Releases](https://github.com/JayzoMods/Prompter-Release/releases). This repository holds release artifacts only — not the application source.

## What to run

Install **`Prompter-0.2.6-win-x64.exe`** (NSIS installer). You can choose a folder; it adds Start Menu and desktop shortcuts.

The zip **`Prompter-0.2.6-win-x64.zip`** is fine if you prefer to unpack a folder.
