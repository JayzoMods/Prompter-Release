...
Current build: **0.2.2**. Download it from [Releases](https://github.com/JayzoMods/Prompter-Release/releases). This repository holds release artifacts only — not the application source.

## What to run

Install **`Prompter-0.2.2-win-x64.exe`** (NSIS installer). You can choose a folder; it adds Start Menu and desktop shortcuts.

The zip **`Prompter-0.2.2-win-x64.zip`** is fine if you prefer to unpack a folder.
...
A short tutorial explains the two panes and Connect. Skip it if you already know the app. Replay anytime: **Settings → How Prompter works**.
...
6. **Copy** from the right pane (or Save .md). That text is for the target agent, not Prompter answering you.
